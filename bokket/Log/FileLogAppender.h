...
public:
    FileLogAppender(const std::string basename,size_t rollSize,int flushInterval,FileWriterType writerType,typename LogEvent::ptr event);
    ...
    bool rollFile(typename LogEvent::ptr event);
private:
